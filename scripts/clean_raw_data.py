...
if __name__ == "__main__":
    ...
    for hdf5_path in hdf5_paths:
        try:
            debug_print("clean_war_data", f"converting {hdf5_path}.", "INFO")
            ...
            debug_print("clean_war_data", f"converting {hdf5_path} Fail: \n{e}", "INFO")
            fail_episode_list.append(hdf5_path)
    
    fail_save_path = os.path.join(output_path, task_name, "fail_episodes.txt")
    # ---------- 保存失败列表 ----------
